...
import workFlows.RequestDemoPageFlows;
...
public abstract class Base {
    ...
    public RequestDemoPageFlows requestDemoPageFlows;
    ...
    protected void initCore() {
        ...
        try {
            ...
            requestDemoPageFlows = new RequestDemoPageFlows(this, requestDemoPage, homePage);
